\documentclass[conference,retainorgcmds]{IEEEtran}
...
\title{\textsf{\huge iSklearn}: automated machine learning with \textsf{\huge irace}}
...
\appendices
\input{appendices/config-space}
\input{appendices/datasets}
\input{appendices/pipelines}
